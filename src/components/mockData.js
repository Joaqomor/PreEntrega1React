const plants = [
    {
        ...
        name:"Potus",
        desc:"lorem impsum",
        detail:"El poto o potus es una planta de hoja perenne con forma de corazón. Puede alcanzar una altura máxima de 20 metros. Al principio, las hojas crecen enteras, pero posteriormente (al alcanzar la madurez) es normal que se vuelvan pinnadas.",
        price:"6€",
        img:"../Images/Potus.jpg",
        category:"int"
    ...
    },
    {
        ...
        name:"Orquidea",
        desc:"lorem impsum",
        detail:"Las orquídeas u orquidáceas (nombre científico Orchidaceae) son una familia de plantas monocotiledóneas que se distinguen por la complejidad de sus flores y por sus interacciones ecológicas con los agentes polinizadores y con los hongos con los que forman micorrizas.",
        price:"15€",
        img:"../Images/Orquidea.jpg",
        category:"int"
    ...
    },
    {
        ...
        price:"8€",
        img:"../Images/AlegriaDelHogar.jpg",
        category:"ext"
    ...
    },
    {
        ...
        name:"Jacinto",
        desc:"lorem impsum",
        detail:"El jacinto (en latín Hyacinthus) es un género de plantas perenne y bulbosas perteneciente a la subfamilia de las escilóideas dentro de las asparagáceas. Es originario de la región mediterránea y África meridional.",
        price:"7€",
        img:"../Images/Jacinto.jpg",
        category:"int",
    ...
    },
    {
        ...
        name:"Bromelia",
        desc:"lorem impsum",
        detail:"Bromelia es un género tropical americano de plantas de la familia Bromeliaceae, aunque comúnmente se llama con el mismo nombre a plantas de otros géneros de la misma familia. Sus flores tienen un cáliz muy profundo.",
        price:"12€",
        img:"../Images/Bromelia.jpg",
        category:"ext",
